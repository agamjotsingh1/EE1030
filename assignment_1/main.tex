...
\section*{ C. MCQs with One Correct Answer}
    ...
    %Question16
\item In a triangle $\vec{P}\vec{Q}\vec{R}$, $\angle \vec{R} = \frac{\pi}{2}$. If $\tan{\frac{P}{2}}$ and $\tan{\frac{Q}{2}}$ are the roots of the equation $ax^2+bx+c=0 \;\brak{a\neq0}$ then
        
        \rightline{\brak{1999 - 2 Marks}}
        \begin{enumerate}[label={(\alph*)}]
            \begin{multicols}{2}
                \item $a+b=c$
                \columnbreak
