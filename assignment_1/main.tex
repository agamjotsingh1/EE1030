...
\section*{\color{black}\colorbox{gray}{ C. }\color{white}\colorbox{magenta}{MCQs with One Correct Answer}}
    ...
    \item The value of the expression $\sqrt{3}\;cosec\;20^\circ-sec\;20^\circ$ is equal to
        ...
        \begin{enumerate}[label={(\alph*)}]
            \begin{multicols}{2}
                \item 2
                \columnbreak
                \item $2\sin{20^\circ}/\sin{40^\circ}$
            \end{multicols}
            \begin{multicols}{2}
                \item 4
                \columnbreak
                \item $4\sin{20^\circ}/\sin{40^\circ}$
            \end{multicols}
        \end{enumerate}
    ...
    \item The general solution of \\$\sin{x}-3\sin{2x} + \sin{3x} = \cos{x}-3\cos{2x} + \cos{3x}$
        ...
        \begin{enumerate}[label={(\alph*)}]
            \begin{multicols}{2}
                \item $n\pi+\dfrac{\pi}{8}$
                \columnbreak
                \item $\dfrac{n\pi}{2}+\dfrac{\pi}{8}$
            \end{multicols}
            \begin{multicols}{2}
                \item $(-1)^n\dfrac{n\pi}{2}+\dfrac{\pi}{8}$
                \columnbreak
                \item $2n\pi+\cos^{-1}{\dfrac{3}{2}}$
            \end{multicols}
        \end{enumerate}
    ...
    \item The equation $\brak{\cos{p}-1}x^2+\brak{\cos{p}}x+\sin{p}=0$ in the variable $x$, has real roots. Then $p$ can take any value in the interval
        ...
        \begin{enumerate}[label={(\alph*)}]
            ...
            \begin{multicols}{2}
                \item $\brak{-\dfrac{\pi}{2},\dfrac{\pi}{2}}$  
                \columnbreak
                \item $\brak{0,\pi}$
            \end{multicols}
        \end{enumerate}
    ...
    %Question10
    \item Let $0<x<\dfrac{\pi}{4}$ then $\brak{\sec{2x} - \tan{2x}}$ equals
        
        \rightline{\color{magenta}\brak{1994}}
        \begin{enumerate}[label={(\alph*)}]
            \begin{multicols}{2}
                \item $\tan{\brak{x-\dfrac{\pi}{4}}}$
                \columnbreak
                \item $\tan{\brak{\dfrac{\pi}{4}-x}}$
            ...
            \begin{multicols}{2}
                \item $\tan{\brak{x+\dfrac{\pi}{4}}}$ 
                \columnbreak
                \item $\tan^{2}{\brak{x+\dfrac{\pi}{4}}}$
            \end{multicols}
        \end{enumerate}

    %Question11
    \item Let n be a positive integer such that\\$\sin{\dfrac{\pi}{2n}} + \cos{\dfrac{\pi}{2n}} = \dfrac{\sqrt{n}}{2}$. Then
    ...
    \item The general values of $\theta$ satisfying the equation\\$2sin^2{\theta}-3\sin{\theta}-2=0 is$
        ...
        \begin{enumerate}[label={(\alph*)}]
            \begin{multicols}{2}
                \item $n\pi + \brak{-1}^n\pi/6$
                \columnbreak
                \item $n\pi + \brak{-1}^n\pi/2$
                
            \end{multicols}

            \begin{multicols}{2}
                \item $n\pi + \brak{-1}^n5\pi/6$ 
                \columnbreak
                \item $n\pi + \brak{-1}^n7\pi/6$
            \end{multicols}
        \end{enumerate}
